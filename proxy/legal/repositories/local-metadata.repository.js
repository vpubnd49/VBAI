...
function getLocalMetadataByDocumentNumber(docNumber = '') {
  ...
  return {
    ...
    summary: raw.tom_tat_chinh_sach || '',
    tom_tat_chinh_sach: raw.tom_tat_chinh_sach || '',
    chapterArticleSummary: raw.tom_tat_chuong_dieu || '',
    tom_tat_chuong_dieu: raw.tom_tat_chuong_dieu || '',
    pdfDownloadUrl: raw.pdf_download_url || raw.pdfDownloadUrl || null,
    pdf_download_url: raw.pdf_download_url || raw.pdfDownloadUrl || null,
    pdfDownloadUrls: raw.pdf_download_urls || raw.pdfDownloadUrls || (raw.pdf_download_url ? [raw.pdf_download_url] : []),
    pdf_download_urls: raw.pdf_download_urls || raw.pdfDownloadUrls || (raw.pdf_download_url ? [raw.pdf_download_url] : []),
