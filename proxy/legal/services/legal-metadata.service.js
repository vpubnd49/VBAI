...
function resolveMetadataForDocument(docNumber = '') {
  ...
  if (knownDoc) {
    return {
      ...
      official_source_urls: knownDoc.official_source_urls || [],
      pdfDownloadUrl: knownDoc.pdf_download_url || knownDoc.pdfDownloadUrl || null,
      pdf_download_url: knownDoc.pdf_download_url || knownDoc.pdfDownloadUrl || null,
      pdfDownloadUrls: knownDoc.pdf_download_urls || knownDoc.pdfDownloadUrls || (knownDoc.pdf_download_url ? [knownDoc.pdf_download_url] : []),
      pdf_download_urls: knownDoc.pdf_download_urls || knownDoc.pdfDownloadUrls || (knownDoc.pdf_download_url ? [knownDoc.pdf_download_url] : []),
      sourceTier: 'official',
      retrievedAt: null,
      contentSha256: null,
