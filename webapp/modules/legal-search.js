          ...
          <div class="legal-query-box-card">
            <div class="legal-search-box-unified">
              ...
              <button id="legal-search-btn" class="btn btn-primary legal-search-submit-btn">
                <span class="search-submit-badge">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#7c3aed" stroke-width="2.5"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                </span>
                <span>Tra cứu</span>
              </button>
            </div>
