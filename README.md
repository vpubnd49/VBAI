...
|:---:|:---|:---|:---:|
| 1 | `Skill_The_Thuc_VB_Dang_HD36/` | Sinh VB Đảng chuẩn HD 36-HD/VPTW | 🇻🇳 |
...
```bash
# Cho Skill VB Đảng HD36
cd Skill_The_Thuc_VB_Dang_HD36 && npm install
...
- *"Soạn nghị quyết của Tỉnh ủy..."* → Skill HD36
